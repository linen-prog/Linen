...
export const userProfiles = pgTable(
  'user_profiles',
  {
    ...
    companionTone: text('companion_tone').default('warm').notNull(),
    companionDirectness: text('companion_directness').default('gentle').notNull(),
    companionSpiritualIntegration: text('companion_spiritual_integration').default('moderate').notNull(),
    companionResponseLength: text('companion_response_length').default('medium').notNull(),
    companionCustomPreferences: text('companion_custom_preferences').default('').notNull(),
    preferencesSet: boolean('preferences_set').default(false).notNull(),
    createdAt: timestamp('created_at').defaultNow().notNull(),
    updatedAt: timestamp('updated_at').defaultNow().$onUpdate(() => new Date()).notNull(),
  },
  (table) => [
