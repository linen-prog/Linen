...
import { View, Text, StyleSheet, ScrollView, TouchableOpacity, Alert, Image, Modal, TextInput, Switch, ActivityIndicator, Linking, KeyboardAvoidingView, Platform } from 'react-native';
...
export default function ProfileScreen() {
  ...
  const handleUploadPhoto = async () => {
    console.log('ProfileScreen (iOS): Upload photo button pressed');
    try {
  ...
  const handleSelectIcon = async (iconId: string) => {
    ...
    try {
      ...
      console.error('ProfileScreen (iOS): Icon selection failed -', error);
  ...
  const handleSavePresenceMode = async () => {
    ...
    try {
      ...
      console.error('ProfileScreen (iOS): Save presence mode failed -', error);
  ...
  const handleSaveBoundaries = async () => {
    ...
    try {
      ...
      console.error('ProfileScreen (iOS): Save boundaries failed -', error);
  ...
  const handleSaveNotifications = async () => {
    ...
    try {
      ...
      console.error('ProfileScreen (iOS): Save notifications failed -', error);
  ...
  const handleOpenPrivacyPolicy = async () => {
    console.log('ProfileScreen (iOS): Opening privacy policy');
    ...
    try {
      ...
      console.error('ProfileScreen (iOS): Failed to open privacy policy -', error);
      ...
      >
        ...
        <View style={[styles.card, { backgroundColor: colors.card }]}>
          <TouchableOpacity 
            ...
            onPress={() => {
              console.log('ProfileScreen (iOS): Avatar pressed');
