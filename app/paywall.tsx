...
const FEATURES = [
  {
    ...
    description: "Personalized daily reflections and encouragement",
  },
  {
    icon: "🌿",
    title: "Deeper AI Support",
    description: "Richer, more meaningful AI-powered conversations",
  },
  {
    icon: "📖",
    title: "Full Scripture Access",
    description: "Complete library of guided scripture and practices",
  },
  {
    icon: "🎁",
    title: "Daily Gifts & Recaps",
    description: "Exclusive daily gifts and weekly spiritual recaps",
  },
];
