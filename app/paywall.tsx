...
const FEATURES = [
  {
    ...
    description: "Unlock every daily reflection, scripture, and somatic practice",
  },
  {
    icon: "🎨",
    title: "Artwork Canvas",
    description: "Express your faith through creative drawing and share with the community",
  },
  {
    icon: "🤝",
  ...
  },
  {
    icon: "📖",
    title: "Weekly Recaps",
    description: "Review your spiritual journey with full weekly summaries",
  },
];
